...
public class StringTest {
	public static void main(String[] args) {
		...
		while(sc.hasNextInt()) {       //입력값이 들어올때까지 while문 내부가 실행되지 않다가
			intlist.add(sc.nextInt()); //int가 아닌 형이 나오면 중단됨
		}
		...
		System.out.println(sb10);  //스트링 버퍼값aaa // 둘다 같은 메모리를 사용하기때문에 값이 같이 바
